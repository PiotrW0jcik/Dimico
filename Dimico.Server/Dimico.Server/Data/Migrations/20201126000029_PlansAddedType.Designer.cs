...
namespace Dimico.Server.Data.Migrations
{
    ...
    [Migration("20201126000029_PlansAddedType")]
    partial class PlansAddedType
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dimico.Server.Data.Models.Follow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dimico.Server.Data.Models.Plan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dimico.Server.Data.Models.Follow", b =>
                {
                    b.HasOne("Dimico.Server.Data.Models.User", "Follower")
                        .WithMany()
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Dimico.Server.Data.Models.User", "User")
                        .WithMany()
